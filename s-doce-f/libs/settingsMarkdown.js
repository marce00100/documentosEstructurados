...
settingsMarkdown = {
	...
	markupSet: [
		{name:'Título 1', key:'1', placeHolder:'Escriba el título aquí...', closeWith:function(markItUp) { return miu.markdownTitle(markItUp, '=') } },
		{name:'Título 2', key:'2', placeHolder:'Escriba el título aquí...', closeWith:function(markItUp) { return miu.markdownTitle(markItUp, '-') } },
